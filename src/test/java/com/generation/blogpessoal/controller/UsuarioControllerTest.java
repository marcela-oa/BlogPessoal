...
public class UsuarioControllerTest {
	...
	public void deveMostrarOUsuarioPeloId() {
		...
		Optional<Usuario> usuario = usuarioService.cadastrarUsuario(new Usuario(0L, 
				"Pamela Batista", "pamela_batista@email.com.br", 
				"pamela123", "https://i.imgur.com/yDRVeK7.jpg"));	
	...
	public void usuarioConsegueFazerLogin () {
		...
		usuarioService.cadastrarUsuario(new Usuario(0L, "Marcela Oliveira", "marcela_oliveira@email.com.br", "13465278", "https://i.imgur.com/JR7kUFU.jpg"));

		HttpEntity<UsuarioLogin> requisicao = new HttpEntity<UsuarioLogin>(new UsuarioLogin("marcela_oliveira@email.com.br", "13465278"));
